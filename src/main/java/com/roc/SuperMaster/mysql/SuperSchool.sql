...
create table if not exists students(
    student_id                         varchar(250)     auto_increment not null primary key ,
...
#---------------------------------------------------------------------------------------------
    ...
    create_status                      boolean             null         comment '删除状态'
)character set = utf8 ENGINE = InnoDB comment '学生信息表';

#创建监护人信息表
create table if not exists guardian
(
    guardian_id                         varchar(250) auto_increment not null primary key,
...
#----------------------------------------------------------------------------------------------------
    ...
    delete_time                         datetime                    null          comment '删除时间',
    create_status                       boolean                     null          comment '删除状态'
) character set = utf8 ENGINE = InnoDB comment '监护人信息表';